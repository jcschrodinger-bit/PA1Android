...
fun CartItemRow(nombre: String, precio: Int) {
    Row( // Fila horizontal para el producto en el carrito
        modifier = Modifier
            .fillMaxWidth()
        ...
        Column(modifier = Modifier.weight(1f)) { // Contenedor vertical para los datos del producto
            Text(
                text = nombre,
                color = Color.White,
                fontSize = 16.sp,
...
fun PaymentSummaryPanel(total: Int) {
    Card( // Tarjeta para el resumen del pago
        modifier = Modifier.fillMaxWidth(),
        shape = RoundedCornerShape(16.dp),
        colors = CardDefaults.cardColors(containerColor = Color.White),
        elevation = CardDefaults.cardElevation(defaultElevation = 2.dp)
    ) {
        Row( // Fila horizontal para mostrar el total
            modifier = Modifier
                .padding(20.dp)
                .fillMaxWidth(),
